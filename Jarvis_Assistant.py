	...
	try: 
		if "search" in input: 
			...
			if "Divyansh" in recipent:
				...
				mail.ehlo()
				mail.starttls()
				mail.login('divyansh042009@gmail.com', 'gangapur@2009')
				mail.sendmail('divyansh042009@gmail.com', 'divyansh042009@gmail.com', content)
				mail.close()
			...
			domain = get_audio()
			os.system("google-chrome " + "https://www." + domain)
...
def search_web(input): 
	...
	if "youtube" in input.lower(): 
		...
		os.system("google-chrome " + "http://www.youtube.com/results?search_query =" + "+".join(query)) 
		return
		...
		query = input.split()[indx + 1:] 
		os.system( "google-chrome " + "https://en.wikipedia.org/wiki/" + "_".join(query)) 
		return
		...
		if "google" in input: 
			...
			query = input.split()[indx + 1:] 
			os.system("google-chrome " + "https://www.google.com/search?q =" + "+".join(query)) 
			...
			os.system("google-chrome "+"https://www.google.com/search?q =" + "+".join(input.split())) 
